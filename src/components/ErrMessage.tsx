    ...
    <div className="flex flex-col gap-2 text-sm">
      {browser?.includes("Firefox") ? (
        <>
          <p>
            {
              "Are you using Firefox? You may have Enhanced Tracking Protection enabled."
            }
          </p>
          <p>
       ...
       <p>{"Hamdit can't connect to Reddit. This may be because Reddit is down or because your browser or a browser extension is blocking this connection. "}</p>
      }
